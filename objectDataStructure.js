...
// 6- Implement object destructuring manually
// const user = {
//   name: "sehnnawy",
//   age: 27,
//   email: "ahmedshennawy997@gmail.com",
// };
// function destructureObj(obj, pattern) {
//   if (!obj || typeof obj !== "object") return {};
//   const result = {};

//   // iterate through each property pattern
//   for (let [key, config] of Object.entries(pattern)) {
//     // simple extraction : {name: true} - just extract the property
//     if (config === true) {
//       result[key] = obj[key];
//     }

//     // with default values: {name:'defaultValue'} - use default value if undefined
//     else if (typeof config !== "object" || config === null) {
//       result[key] = obj[key] !== undefined ? obj[key] : config;
//     }

//     // advanced config : {name: {as: 'newName', default:'value'}}
//     // supports both renaming and default values
//     else {
//       const newName = config.as || key; // use 'as' for rename, otherwise keep original
//       const value = obj[key] !== undefined ? obj[key] : config.default;
...
// console.log(destructureObj(user, { name: true, age: true }));
// console.log(destructureObj(user, { name: true, phone: "N/A" }));
// console.log(
//   destructureObj(user, {
//     name: { as: "ahmed" },
//     age: true,
